...
import kotlinx.android.synthetic.main.sales_youtube_view.view.*

class SalesYoutubeView @JvmOverloads constructor(
    context: Context,
    ...
    init {
        LayoutInflater.from(context).inflate(R.layout.sales_youtube_view, this, true)
    }
