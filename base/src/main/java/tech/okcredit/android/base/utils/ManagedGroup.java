...
// This class is written to control visibility of individual views in the group
...
public class ManagedGroup extends Group {
    ...
    /**
     * Remove reference ids from the group. This is done automatically when setVisibility(View view,
     * int visibility) is called.
     *
