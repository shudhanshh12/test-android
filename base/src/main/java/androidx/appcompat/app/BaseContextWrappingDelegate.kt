...
// As Philology library was not compatible with AppCompat:1.2.0 We used these https://github.com/JcMinarro/Philology/issues/35 and https://stackoverflow.com/questions/55265834/change-locale-not-work-after-migrate-to-androidx/58004553#58004553
// links to fix this issue.In future some new fix might be needed.
...
class BaseContextWrappingDelegate(private val superDelegate: AppCompatDelegate) : AppCompatDelegate() {
    ...
    override fun createView(parent: View?, name: String?, context: Context, attrs: AttributeSet): View? =
        superDelegate.createView(parent, name, context, attrs)
