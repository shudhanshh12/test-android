...
import kotlinx.android.synthetic.main.add_transaction_fragment_calculator_view.view.*
...
class CalculatorView @JvmOverloads constructor(
    ...
    init {
        LayoutInflater.from(ctx).inflate(R.layout.add_transaction_fragment_calculator_view, this, true)
    }
