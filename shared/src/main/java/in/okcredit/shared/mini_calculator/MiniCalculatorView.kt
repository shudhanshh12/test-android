...
import kotlinx.android.synthetic.main.mini_add_transaction_fragment_calculator_view.view.*

@ModelView(autoLayout = ModelView.Size.MATCH_WIDTH_WRAP_HEIGHT)
class MiniCalculatorView @JvmOverloads constructor(
    ctx: Context,
    ...
    init {
        LayoutInflater.from(ctx).inflate(R.layout.mini_add_transaction_fragment_calculator_view, this, true)
    }
