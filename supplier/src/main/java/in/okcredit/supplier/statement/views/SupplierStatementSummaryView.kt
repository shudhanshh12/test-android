...
import `in`.okcredit.supplier.databinding.SupplierStatementSummaryBinding
...
class SupplierStatementSummaryView @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0
) : FrameLayout(context, attrs, defStyleAttr) {

    private val binding = SupplierStatementSummaryBinding.inflate(LayoutInflater.from(context), this, true)
