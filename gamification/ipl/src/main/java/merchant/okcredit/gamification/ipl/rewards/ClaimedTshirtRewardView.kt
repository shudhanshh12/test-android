...
import merchant.okcredit.gamification.ipl.databinding.ClaimedTshirtRewardSmallBinding
...
class ClaimedTshirtRewardView @JvmOverloads constructor(
    context: Context,
    val attrs: AttributeSet? = null,
    val defStyleAttr: Int = 0,
) : FrameLayout(context, attrs, defStyleAttr) {

    private val binding = ClaimedTshirtRewardSmallBinding.inflate(LayoutInflater.from(context), this)
