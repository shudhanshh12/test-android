...
import merchant.okcredit.gamification.ipl.databinding.GameRulesNewBinding
import tech.okcredit.android.base.extensions.gone
import tech.okcredit.android.base.extensions.isVisible
import tech.okcredit.android.base.extensions.visible

@ModelView(autoLayout = ModelView.Size.MATCH_WIDTH_WRAP_HEIGHT)
class GameRulesCardNew @JvmOverloads constructor(
    context: Context,
    ...
    private val binding: GameRulesNewBinding =
        GameRulesNewBinding.inflate(LayoutInflater.from(context), this, true)
