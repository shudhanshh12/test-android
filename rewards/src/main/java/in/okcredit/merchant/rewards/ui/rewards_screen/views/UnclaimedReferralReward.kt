...
class UnclaimedReferralReward @JvmOverloads constructor(
    context: Context,
    ...
    fun setReward(rewards: RewardModel) {
        binding.ivImage.setImageDrawable(ContextCompat.getDrawable(context, R.drawable.ic_referral_unclaimed_rewards))
        binding.apply {
            when {
                rewards.isOnHold() -> {
                    tvTitle.gone()
