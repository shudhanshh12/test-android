...
class ClaimedReferralReward @JvmOverloads constructor(
    context: Context,
    ...
    fun setReward(reward: RewardModel) {
        ...
        binding.ivImage.setImageDrawable(ContextCompat.getDrawable(context, R.drawable.ic_referral_claimedreward))
