...
class ReleaseMailGenerator:
    MASTER_LABEL_LIST = set(
        ["Growth", "B2B", "B2C", "Platform", "Core Experience", "Revenue", "Translations"]
    )
    PAGE_ITEM_COUNT = 200
    ...
    LIST_CLOSE_TAG = '</ul>'
    MESSAGE = '<p>Android app {} has been pushed to the Play Store on the internal track. Please review the build and give sign off soon</p>'
